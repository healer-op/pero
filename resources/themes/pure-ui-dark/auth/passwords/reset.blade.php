			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" id="resetForm" action="{{ route('auth.reset.post') }}" method="post">
					...
					<div class="text-center p-t-90">
						<a class="txt2" href="#">
							<p class="small login-copyright text-center">Copyright &copy; 2015 - {{ date('Y') }} <a href="https://pterodactyl.io/">Pterodactyl Software</a>. Login form by ColorLib. Theme by Ho0k_.</p>
						</a>
					</div>
